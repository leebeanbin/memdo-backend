...
export default {
  fetch: withApi<any>(async (request, context, currentRequestId) => {
    ...
    return await withCrudErrors('agent-key', currentRequestId, async () => {
      if (request.method === 'GET') {
        ...
        return success({ connected: data !== null }, 200, 'agent_key.status', 0)
      }
      ...
      if (request.method === 'PUT') {
        ...
        return success({ connected: true }, 200, 'agent_key.save', 0)
      }
      ...
      if (request.method === 'DELETE') {
        ...
        return success({ connected: false }, 200, 'agent_key.delete', 0)
      }
